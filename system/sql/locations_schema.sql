...
insert into locations (market_id,floor,floor_order,area,area_order,detail,detail_order) values
-- 市場管理辦公
('market1','3F',40,'市場管理辦公', 10,'主任辦公室',  10),
('market1','3F',40,'市場管理辦公', 10,'副主任辦公室',20),
('market1','3F',40,'市場管理辦公', 10,'會議室A',     30),
('market1','3F',40,'市場管理辦公', 10,'會議室B',     40),
-- 公共服務區
('market1','3F',40,'公共服務區',   20,'展覽廳',      10),
('market1','3F',40,'公共服務區',   20,'員工餐廳',    20),
('market1','3F',40,'公共服務區',   20,'廁所',        30),
-- 公共區域
('market1','3F',40,'公共區域',     30,'電梯出入口',  10),
('market1','3F',40,'公共區域',     30,'樓梯出入口',  20),
('market1','3F',40,'公共區域',     30,'走廊',        30)
on conflict (market_id,floor,area,detail) do nothing;
...
insert into locations (market_id,floor,floor_order,area,area_order,detail,detail_order) values
-- 1F 一樓
('admin','1F',10,'大廳接待區',   10,'接待櫃台',    10),
('admin','1F',10,'大廳接待區',   10,'等候區',      20),
('admin','1F',10,'警衛室',       20,'警衛值班室',  10),
('admin','1F',10,'警衛室',       20,'監控中心',    20),
('admin','1F',10,'機電設備室',   30,'配電室',      10),
('admin','1F',10,'機電設備室',   30,'消防設備室',  20),
('admin','1F',10,'機電設備室',   30,'發電機房',    30),
('admin','1F',10,'公共區域',     40,'電梯大廳',    10),
('admin','1F',10,'公共區域',     40,'樓梯間',      20),
-- 2F 二樓
('admin','2F',20,'財務出納區',   10,'財務室',      10),
('admin','2F',20,'財務出納區',   10,'出納室',      20),
('admin','2F',20,'人事行政區',   20,'人事室',      10),
('admin','2F',20,'人事行政區',   20,'總務室',      20),
('admin','2F',20,'資訊機房',     30,'伺服器機房',  10),
('admin','2F',20,'資訊機房',     30,'UPS 設備區',  20),
('admin','2F',20,'公共區域',     40,'走廊',        10),
('admin','2F',20,'公共區域',     40,'廁所',        20),
-- 3F 三樓
('admin','3F',30,'主管辦公區',   10,'總經理室',    10),
('admin','3F',30,'主管辦公區',   10,'副總經理室',  20),
('admin','3F',30,'主管辦公區',   10,'秘書室',      30),
('admin','3F',30,'大會議室',     20,'會議室A',     10),
('admin','3F',30,'大會議室',     20,'會議室B',     20),
('admin','3F',30,'公共區域',     30,'走廊',        10),
('admin','3F',30,'公共區域',     30,'廁所',        20),
-- 4F 四樓
('admin','4F',40,'多功能廳',     10,'主廳',        10),
('admin','4F',40,'多功能廳',     10,'準備室',      20),
('admin','4F',40,'員工設施',     20,'員工餐廳',    10),
('admin','4F',40,'員工設施',     20,'休息室',      20),
('admin','4F',40,'屋頂設備區',   30,'冷卻水塔',    10),
('admin','4F',40,'屋頂設備區',   30,'空調主機',    20)
on conflict (market_id,floor,area,detail) do nothing;
